...
We are going to create a module called `biketrauma` to visualize the `bicycle_db`, used in the some of these lectures.
...
See the git repo of the course: the subfolder: contains some files you should include into your package tree:
