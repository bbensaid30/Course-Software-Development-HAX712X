...
We provide some examples in the `pandas` section of the website, and also in the [Scipy](Scipy.qmd) course.
...
For instance, see the course [Creating a Python module](../OPP/modules.qmd), such a map is constructed:
