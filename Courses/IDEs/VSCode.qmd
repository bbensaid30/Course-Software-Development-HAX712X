...
3. Next, you have to learn how to debug a simple Python script, see the [VSCode help on debugging](https://code.visualstudio.com/docs/python/debuggings) for that.
:::
