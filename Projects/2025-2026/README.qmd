...
- sources of energy, see [this webpage](https://www.carbonbrief.org/mapped-how-the-us-generates-electricity/) or [this app](https://globalenergymonitor.org/projects/global-coal-plant-tracker/dashboard/)
- population/demographic issues, see this [advanced interractive app](https://manpopex.us/)
- an ecological issue like [this one](https://interactive.carbonbrief.org/can-great-barrier-reef-survive-climate-change/index.html)
- sncf traffic, ...
...
## Some source of datasets:

Here some dataset website are listed:

- [openstreetmap](https://www.openstreetmap.fr/donnees/) (api)
- [openrouteservice](https://api.openrouteservice.org/) (api)
- [gapminder](https://www.gapminder.org/data/)
- [USenergyadmin](https://www.eia.gov/electricity/)
...
- **The GitHub repository** with the **presentations slides** should be completed before **Wednesday 10 December (23:59)**. This part corresponds to **40% of the final grade**.  <span style="color:red;">Nothing pushed after the deadline will be taken into account.</span>

- The oral presentation (15mn + 5mn questions)  **December 12 (8:00)** (SC 36.04). This part corresponds to **35% of the final grade**.
...
* a website with `quarto` or with `sphinx` (or others) that presents your project. This website should be deployed through GitHubPages. 
...
It is better if the data used should be available in a way that the end user does not need to perform a manual download of any kind (use the `pooch` package or variants for instance).
...
|---------  |------------------------------------------------|------------|
|**Code**   |Problem Resolution/Narration                    |5           |
...
|           |Graphical aspects: Widgets, clickable map, etc. |5           |
