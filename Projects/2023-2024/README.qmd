...
You will need to work all along the semester to achieve these projects. Please start to work on it as soon as possible. You need to use your GitHub account (see [Git lecture](../../Courses/Git/Basis_PartII.qmd)) as the expected outputs for this course are GitHub repositories.
